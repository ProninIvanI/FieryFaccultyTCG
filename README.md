...
Файл `NOTES.md` в корне проекта считается личным локальным файлом заметок пользователя.

Правила:
- `NOTES.md` не коммитится в репозиторий;
- `NOTES.md` не используется как источник требований по проекту;
- `NOTES.md` не используется для анализа текущего состояния проекта, архитектуры, багов или плана работ;
- `NOTES.md` не должен отправляться на сервер, в логи, в артефакты или в любые автоматические отчёты;
- при работе по проекту нужно опираться на код, основные MD-документы и явные указания пользователя, а не на `NOTES.md`.
